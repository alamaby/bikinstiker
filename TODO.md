...
- [ ] **SH2b (manual, owner)** `supabase db push` **lagi** (migrasi 20260830000002) → lapor → agent jalankan ulang suite curl (harus: 35 fungsi client + 11 views `permission denied` untuk anon) + smoke app penuh (guest generate, check-in, surprise me, packs CRUD, showcase browse+purchase, legal gate, share link).
